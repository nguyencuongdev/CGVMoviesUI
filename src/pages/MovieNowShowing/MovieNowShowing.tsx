import styles from './MovieNowShowing.module.scss';
...
function MovieNowShowing() {
  return (
    <div className={cn(styles['movie-now-showing'])}>
      <h1 className={cn(styles['movie-now-showing-title'], 'text-[28px] text-[#222] my-3')}>
      ...
      <div className={cn(styles['movie-now-showing-list'], 'grid grid-cols-4 gap-x-16 gap-y-6')}>
        <div className={cn(styles['movie-now-showing-item'], 'relative')}>
          ...
          <div className={cn(styles['moviw-now-showing-item-info'])}>
            <h4
              className={cn(
                'movie-now-showing-name font-bold text-[#333] uppercase my-2 text-ellipsis text-nowrap overflow-hidden',
              )}>
              Nhà gia tiên
            </h4>
          ...
          <div className={cn(styles['movie-now-showing-item__btn'], 'flex mt-6 items-center')}>
